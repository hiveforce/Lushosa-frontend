import AdminCategoryOverview from "../../components/Admin/Products/Categories/AdminCategoryOverview";
import SearchFilterSort from "../../ui/SearchFilterSort";

function AdminCategoriesProducts() {
  return (
    <div className="pl-5  py-8 md:pl-10 lg:pl-[18px]">
      <div className="flex justify-between items-center  flex-wrap mr-5">
        <div>
          <h1 className="font-bold text-[24px]">Categories Management</h1>
          <p className="text-[#5c5c5c] text-[14px] font-normal">
            Organize and manage your wig product categories
          </p>
        </div>
...
export default AdminCategoriesProducts;
